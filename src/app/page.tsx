...
const DirectionsModal = dynamic(() => import('@/components/app/modals/DirectionsModal'), { ssr: false });
  ...
  // These are rendered *instead of* the main screen content when active.
    ...
    mainContent = (
      <SettingsScreen
        ...
        onShowProfile={() => { setShowSettings(false); setShowProfile(true); }} // NEW: Navigate to profile from settings
        onShowEnable2FA={() => { setShowSettings(false); setShowEnable2FA(true); }} // NEW: Navigate to 2FA enable from settings
        onShowUpdateProfile={() => { setShowSettings(false); setShowUpdateProfile(true); }} // NEW: Navigate to profile update from settings
