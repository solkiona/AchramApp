...
export default function Disable2FAModal({
  ...
  return (
    <div className="fixed inset-0 bg-achrams-secondary-solid/50 bg-opacity-70 flex items-end z-50">
      <div className="bg-achrams-bg-primary w-full  mx-auto rounded-t-3xl p-6 animate-slideUp max-h-[90vh] overflow-y-auto border-t border-achrams-border max-w-md mx-auto">
